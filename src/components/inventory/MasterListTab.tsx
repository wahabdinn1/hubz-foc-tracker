...
import { getReturnUrgency, isItemOverdue } from "@/lib/date-utils";
import {
    Search,
    Filter,
    Package,
                                    ...
                                    >
                                        ...
                                        <div className="grid grid-cols-2 gap-2 text-sm mt-1 border-t border-black/5 dark:border-white/5 pt-3">
                                            ...
                                            <div className="flex flex-col">
                                                ...
                                                <span className={cn("font-medium text-xs font-mono", overdue ? "text-red-500" : "text-neutral-700 dark:text-neutral-300")}>{item.plannedReturnDate || "-"}</span>
                                            </div>
                                        </div>
                                    </motion.div>
                                );
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-5 py-4 font-mono text-xs whitespace-nowrap">
                                                {(() => {
                                                    const u = getReturnUrgency(item.plannedReturnDate);
                                                    if (!u) return <span className="text-neutral-300 dark:text-neutral-600 italic">—</span>;
                                                    return <span className={u.className}>{u.label}</span>;
                                                })()}
                                            </td>
